      ...
      <section className="py-12 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
            <h1 className="text-3xl md:text-5xl font-extrabold gold-gradient-text mb-4">مكتبة المحتوى</h1>
            <p className="text-slate-500 dark:text-white/40 max-w-xl mx-auto">شروحات ومقالات لمساعدتك في استخدام المنصات الرقمية</p>
          </motion.div>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-8">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-xl bg-slate-100 dark:bg-white/5 border border-gold-border text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-white/20 focus:outline-none focus:border-gold-primary/50 transition-all"
            />
